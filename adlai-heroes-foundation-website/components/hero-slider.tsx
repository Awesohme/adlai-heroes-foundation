      ...
      <div className="relative z-20 text-white px-4 max-w-5xl mx-auto space-y-6">
        ...
        {(currentSlide.button_text && currentSlide.button_link) && (
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              className="bg-adlaiPink text-white hover:bg-adlaiPink/90 px-8 py-3 text-lg shadow-lg hover:shadow-xl transform hover:scale-105 hover:rotate-12 transition-all duration-300"
            >
            ...
            {currentSlide.button_text_2 && currentSlide.button_link_2 && (
              <Button
                asChild
                variant="outline"
                className="bg-adlaiBlue/20 text-white border-adlaiBlue hover:bg-adlaiBlue hover:text-white px-8 py-3 text-lg shadow-lg backdrop-blur-sm hover:shadow-xl transform hover:scale-105 hover:rotate-12 transition-all duration-300"
              >
